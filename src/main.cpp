...
#define Slave_PID 0x43 //LIN ID of the Slave Module We Are Emulating

int lin_cs = 32;
int lin_fault = 28;
CAN_message_t msg;
uint8_t buffer_data[] = {0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff};
uint8_t pos_0[] = {0x00, 0x08, 0x10, 0x18, 0x20, 0x28, 0x30, 0x38, 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x70};
...
void loop () {
    ...
    Serial.print(buffer_data[1], HEX);
    Serial.println();
    delay(100);
